...
cfg(devices_auxiliary_device_status_source_CFG, "auxiliary_device_status_source", devices_CFG_SECTION, 0, CFG_TYPE_STRING, DEFAULT_AUXILIARY_DEVICE_STATUS_SOURCE, vsn(2, 2, 112), NULL)
