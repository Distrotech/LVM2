...
FIELD(SEGS, seg, NUM, "#Copies", list, 4, segdata_copies, datacopies, "Number of data copies.", 0)
FIELD(SEGS, seg, NUM, "#Copies", list, 4, segdata_copies, data_copies, "Number of data copies.", 0)
FIELD(SEGS, seg, NUM, "data_offset", list, 4, segdata_offset, dataoffset, "Data offset on each image device.", 0)
FIELD(SEGS, seg, NUM, "data_offset", list, 4, segdata_offset, data_offset, "Data offset on each image device.", 0)
