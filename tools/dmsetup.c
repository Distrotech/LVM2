					...
					void *private __attribute__((unused)))
{
	...
	if (!(repstr = dm_size_to_string(mem, region_length, units,
					 factor, _show_units(), 1,
					 DM_SIZE_UNIT)))
		return_0;
				    ...
				    void *private __attribute__((unused)))
{
	...
	if (!(repstr = dm_size_to_string(mem, rsec, units, 1, factor,
					 _show_units(), DM_SIZE_UNIT)))
		return_0;
				     ...
				     void *private __attribute__((unused)))
{
	...
	if (!(repstr = dm_size_to_string(mem, wsec, units, 1, factor,
					 _show_units(), DM_SIZE_UNIT)))
		return_0;
				...
				void *private __attribute__((unused)))
{
	...
	if (!(repstr = dm_size_to_string(mem, arqsz, units, 1, factor,
					 _show_units(), DM_SIZE_UNIT)))
		return_0;
...
static void _stats_usage(FILE *out)
{
	...
	fprintf(stderr, "        [--segments] [--units <units>]\n\n");
...
static int _stats(CMD_ARGS)
{
	...
	if (_switches[HELP_ARG]) {
		cmd = _find_stats_subcommand("help");
		goto doit;
	}
